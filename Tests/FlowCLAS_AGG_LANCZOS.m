...
% Load the matrix
name = fullfile("..","examples","matrices/","Flux.mat");
load(name);
A = Amat;
rhs = b;
...
param.smoother.method = 'JACOBI';
param.prolong.proltype = 'EXTI';
param.prolong.prol_emin = 'NONE';
param.coarsen.SoC_type = 'CLA';
param.coarsen.tau = 0.25;
param.coarsen.nl_agg = 1;
param.tspace.method = 'LANCZOS';
param.tspace.ntv = 1;
