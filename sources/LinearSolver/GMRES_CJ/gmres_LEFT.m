%-----------------------------------------------------------------------------------------
%
% LEFT preconditioned GMRES --- Native MATLAB implementation
%
%-----------------------------------------------------------------------------------------

function [x,flag,relres,iter,resvec] = gmres_LEFT(A,b,restart,tol,maxit,M1,M2,x,varargin)
...
for outiter = 1 : outer
    ...
    for initer = 1 : inner
        ...
        %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        if mod((outiter-1)*inner+initer+1,1) == 0
