%-----------------------------------------------------------------------------------------
%
% RIGHT preconditioned GMRES --- Native MATLAB implementation
%
%-----------------------------------------------------------------------------------------
...
%@@@@@@@@@@@@@@@@@@ MODIFICATO QUI (SCAMBIATI A e M) @@@@@@@@@@@@@@@@@@@@@@@@
...
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        if (normr <= tolb || stag >= maxstagsteps || moresteps)
            if evalxm == 0
                ...
                %@@@@@@@@@@@@@@@@@@@@@@ APPLY PRECONDITIONER TO additive @@@@@@@@
                %  Apply Preconditioner.
                if existM1
                    additive = iterapp('mldivide',m1fun,m1type,additive,varargin{:});
                    if ~allfinite(additive)
                        flag = 2;
                        break
                    end
                end
                ...
                if existM2
                    additive = iterapp('mldivide',m2fun,m2type,additive,varargin{:});
                    if ~allfinite(additive)
                        flag = 2;
                        break
                    end
