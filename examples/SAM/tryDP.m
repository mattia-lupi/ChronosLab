...
Name = "StickSlipOpenBigFull"; % richards richardsBig stickSlipFast StickSlipOpenBig nicolas
files = dir('mats/' + Name + '/' + Name + '_*.mat');
fileNames = {files.name};

if contains(Name, ["richards","dp","symMech"])
   lagrange = false;
else
   lagrange = true;
end
...
q  = [4 8 9 17 18 25 32 33 39 47 48];     % Strategy 2: Steps to recompute preconditioner
tP = [];     % Strategy 3: Steps to recompute base preconditioner
tS = [4 8 9 17 18 22];     % Strategy 3: Steps to recompute SAM matrix
